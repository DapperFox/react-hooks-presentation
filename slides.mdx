...
<div style={{display: 'flex'}}>
  <Image style={{width: '100%'}} src="images/example-3.png" />

  <Image style={{width: '100%'}} src="images/example-4.png" />
</div>
...
<div style={{display: 'flex'}}>
  <Image style={{width: '100%'}} src="images/example-5.png" />

  <Image style={{width: '100%'}} src="images/example-6.png" />
</div>
