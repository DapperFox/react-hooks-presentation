...
<div style={{padding: '15%'}}>
  <ul>
    ...
    <li>You can now do side-effecty things (like what you'd normally do in lifcycle methods) in function components</li>
...
<div style={{padding: '15%'}}>
  <ul>
    ...
    <li>Rather than grouping code by *when* it runs (on mount, on unmount, etc) you can group by *why* it runs</li>
  </ul>
</div>
...
<img style={{width: '800px'}} src="images/example-7.png" />
...
<img style={{width: '800px'}} src="images/example-8.png" />
...
<img style={{width: '800px'}} src="images/example-9.png" />
...
<img style={{width: '800px'}} src="images/example-10.png" />
